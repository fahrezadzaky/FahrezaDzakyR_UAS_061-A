...
class DiaGraph{
    ...
    adjNode* getAdjListNode(int value, int weight, adjNode* head){
        ...
        newNode->next = head;   // arahkan simpul baru ke kepala saat ini
        return newNode;
    }
    int N;  //jumlah node dalam grafik
public:
    adjNode **head;                //daftar kedekatan sebagai array pointer
    // Constructor
...
int main()
{
    ...
    int N = 4;      // Jumlah simpul dalam grafik
